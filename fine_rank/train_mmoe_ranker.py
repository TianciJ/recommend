...
def build_feature_info():
    ...
    movie_features, genre_to_index, max_genre_length = load_movie_features()
...
def load_base_samples(ratings_path, feature_info, skip_unknown=True):
    samples = []
